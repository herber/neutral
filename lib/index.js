...
const neutral = (opts) => {
  ...
  emitter.on('route-changed', () => {
    ...
    if (match !== false) {
      ...
      node = xou`<p style="font-family: sans-serif; text-align: center; line-height: calc(100vh - 3em); white-space: nowrap; font-size: 1.5em">
  ...
  routeChanged(() => emitter.emit('route-changed'));
